...
public class L2SummonAI extends L2PlayableAI implements Runnable
{
	...
	protected void onIntentionActive()
	{
		...
		/* l2jtw add start : GS-comment-007
		if (_startFollow)
		{
	...
	public void run()
	{
		if (_startAvoid)
		{
			...
			if (!_clientMoving && !_actor.isDead() && !_actor.isMovementDisabled())
			{
				...
				if ((Config.GEODATA == 0) || GeoData.getInstance().canMove(_actor.getX(), _actor.getY(), _actor.getZ(), targetX, targetY, _actor.getZ(), _actor.getInstantWorldId()))
				{
