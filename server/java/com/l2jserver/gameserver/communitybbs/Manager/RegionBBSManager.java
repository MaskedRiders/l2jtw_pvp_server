...
public class RegionBBSManager extends BaseBBSManager
{
	...
	private void showOldCommunityPI(L2PcInstance activeChar, String name)
	{
		 ...
		 */
		final StringBuilder htmlCode = StringUtil.startAppend(1000, "<html><body><br><table border=0><tr><td FIXWIDTH=15></td><td align=center>" + MessageTable.Messages[76].getMessage() + "<img src=\"sek.cbui355\" width=610 height=1></td></tr><tr><td FIXWIDTH=15></td><td>");
		...
		if (player != null)
		{
			 ...
			 */
			StringUtil.append(htmlCode, "<table border=0><tr><td>", player.getName(), " (", sex, " ", ClassListData.getInstance().getClass(player.getClassId()).getClientCode(), "):</td></tr><tr><td>" + MessageTable.Messages[83].getMessage(), levelApprox, "</td></tr><tr><td><br></td></tr>");
			...
			if ((activeChar != null) && (activeChar.isGM() || (player.getObjectId() == activeChar.getObjectId()) || Config.SHOW_LEVEL_COMMUNITYBOARD))
			{
				 ...
				 */
				StringUtil.append(htmlCode, "<tr><td>" + MessageTable.Messages[83].getMessage(), String.valueOf(player.getLevel()), "</td></tr><tr><td>" + MessageTable.Messages[84].getMessage(), String.valueOf(player.getExp()), "/", String.valueOf(nextLevelExp), "</td></tr><tr><td>" + MessageTable.Messages[85].getMessage(), String.valueOf(nextLevelExpNeeded), "</td></tr><tr><td><br></td></tr>");
			}
			 ...
			 */
			StringUtil.append(htmlCode, "<tr><td>" + MessageTable.Messages[86].getMessage(), String.valueOf(h), MessageTable.Messages[87].getExtra(1), String.valueOf(m), MessageTable.Messages[87].getExtra(2), String.valueOf(s), MessageTable.Messages[87].getExtra(3) + "</td></tr><tr><td><br></td></tr>");
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
	{
		...
		if (ar1.equals("PM"))
		{
			 ...
			 */
			final StringBuilder htmlCode = StringUtil.startAppend(500, "<html><body><br><table border=0><tr><td FIXWIDTH=15></td><td align=center>" + MessageTable.Messages[76].getMessage() + "<img src=\"sek.cbui355\" width=610 height=1></td></tr><tr><td FIXWIDTH=15></td><td>");
			...
			try
			{
				...
				if (receiver == null)
				{
					 ...
					 */
					StringUtil.append(htmlCode, MessageTable.Messages[99].getMessage() + "<br><button value=\"" + MessageTable.Messages[90].getMessage() + "\" action=\"bypass _bbsloc;playerinfo;", ar2, "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table></body></html>");
					separateAndSend(htmlCode.toString(), activeChar);
					return;
				}
				if (Config.JAIL_DISABLE_CHAT && receiver.isJailed())
				{
					/* MessageTable.Messages[100]
				...
				if (!receiver.isSilenceMode(activeChar.getObjectId()) && !BlockList.isBlocked(receiver, activeChar))
				{
					 ...
					 */
					StringUtil.append(htmlCode, MessageTable.Messages[103].getMessage() + "<br><button value=\"" + MessageTable.Messages[90].getMessage() + "\" action=\"bypass _bbsloc;playerinfo;", receiver.getName(), "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table></body></html>");
					separateAndSend(htmlCode.toString(), activeChar);
				}
				else
				{
	...
	private void writeCommunityPages()
	{
		...
		for (int page : _onlinePlayers.keySet())
		{
			 ...
			 */
			StringUtil.append(htmlCode, "<html><body><br><table>" + trOpen + "<td align=left width=\"600\" valign=top>" + MessageTable.Messages[104].getMessage(), String.valueOf(GameServer.dateTimeServerStarted.getTime()), tdClose + trClose + "</table><table>" + trOpen + tdOpen + MessageTable.Messages[105].getMessage(), String.valueOf(Config.RATE_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[106].getMessage(), String.valueOf(Config.RATE_XP * Config.RATE_PARTY_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[107].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_XP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[108].getMessage(), String.valueOf(Config.RATE_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[109].getMessage(), String.valueOf(Config.RATE_SP * Config.RATE_PARTY_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[110].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_SP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[111].getMessage(), String.valueOf(Config.RATE_DEATH_DROP_CHANCE_MULTIPLIER), tdClose + colSpacer + tdOpen + MessageTable.Messages[112].getMessage(), String.valueOf(Config.RATE_CORPSE_DROP_CHANCE_MULTIPLIER), tdClose + colSpacer + tdOpen + MessageTable.Messages[113].getMessage(), String.valueOf(Config.RATE_DROP_AMOUNT_MULTIPLIER.containsKey(Inventory.ADENA_ID) ? Config.RATE_DROP_AMOUNT_MULTIPLIER.get(Inventory.ADENA_ID).floatValue() : 1f), tdClose + trClose + "</table><table>" + trOpen + "<td><img src=\"sek.cbui355\" width=600 height=1><br></td>" + trClose + trOpen + tdOpen, String.valueOf(L2World.getInstance().getVisibleObjectsCount()), MessageTable.Messages[114].getMessage() + "</td>" + trClose + trOpen + tdOpen, String.valueOf(getOnlineCount("gm")), MessageTable.Messages[115].getMessage() + "</td>" + trClose + "</table>");
			...
			if (getOnlineCount("gm") > Config.NAME_PAGE_SIZE_COMMUNITYBOARD)
			{
				 ...
				 */
				StringUtil.append(htmlCode, "<td FIXWIDTH=10></td><td align=center valign=top width=200>" + MessageTable.Messages[118].getExtra(1), String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + 1), " - ", String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + getOnlinePlayers(page).size()), " player(s)</td><td FIXWIDTH=10></td>");
			 ...
			 */
			StringUtil.append(htmlCode, "<html><body><br><table>" + trOpen + "<td align=left width=\"600\" valign=top>" + MessageTable.Messages[104].getMessage(), String.valueOf(GameServer.dateTimeServerStarted.getTime()), tdClose + trClose + "</table><table>" + trOpen + tdOpen + MessageTable.Messages[105].getMessage(), String.valueOf(Config.RATE_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[106].getMessage(), String.valueOf(Config.RATE_PARTY_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[107].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_XP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[108].getMessage(), String.valueOf(Config.RATE_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[109].getMessage(), String.valueOf(Config.RATE_PARTY_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[110].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_SP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[111].getMessage(), String.valueOf(Config.RATE_DEATH_DROP_CHANCE_MULTIPLIER), tdClose + colSpacer + tdOpen + MessageTable.Messages[112].getMessage(), String.valueOf(Config.RATE_CORPSE_DROP_CHANCE_MULTIPLIER), tdClose + colSpacer + tdOpen + MessageTable.Messages[113].getMessage(), String.valueOf(Config.RATE_DROP_AMOUNT_MULTIPLIER.containsKey(Inventory.ADENA_ID) ? Config.RATE_DROP_AMOUNT_MULTIPLIER.get(Inventory.ADENA_ID).floatValue() : 1f), tdClose + trClose + "</table><table>" + trOpen + "<td><img src=\"sek.cbui355\" width=600 height=1><br></td>" + trClose + trOpen + tdOpen, String.valueOf(getOnlineCount("pl")), MessageTable.Messages[115].getMessage() + "</td>" + trClose + "</table>");
			...
			if (getOnlineCount("pl") > Config.NAME_PAGE_SIZE_COMMUNITYBOARD)
			{
				...
				StringUtil.append(htmlCode, "<td FIXWIDTH=10></td><td align=center valign=top width=200>Displaying ", String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + 1), " - ", String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + getOnlinePlayers(page).size()), " player(s)</td><td FIXWIDTH=10></td>");
				 */
				StringUtil.append(htmlCode, "<td FIXWIDTH=10></td><td align=center valign=top width=200>" + MessageTable.Messages[118].getExtra(1), String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + 1), " - ", String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + getOnlinePlayers(page).size()), MessageTable.Messages[118].getExtra(2) + "</td><td FIXWIDTH=10></td>");
