...
public final class NpcStringId
{
	...
	public static final NpcStringId YOU_CANT_RIDE_A_KOOKARU_NOW; // 603
	public static final NpcStringId BEGIN_TUTORIAL_QUESTS; // 603
	public static final NpcStringId NEWBIE_HELPER_HAS_CASTED_BUFFS_ON_S1; // 603
	/**
	...
	static
	{
		...
		YOU_CANT_RIDE_A_KOOKARU_NOW = new NpcStringId(1811297); // 603
		BEGIN_TUTORIAL_QUESTS = new NpcStringId(1600026); // 603
		NEWBIE_HELPER_HAS_CASTED_BUFFS_ON_S1 = new NpcStringId(1600027); // 603
