...
public class Siege implements Siegable
{
	...
	public void registerDefender(L2PcInstance player, boolean force)
	{
		if (getCastle().getOwnerId() <= 0)
		{
			 ...
			 */
			player.sendMessage(MessageTable.Messages[454].getExtra(1) + getCastle().getCName() + MessageTable.Messages[454].getExtra(2));
			return;
		}
	...
	public void startAutoTask()
	{
		 ...
		 */
		_log.info(MessageTable.Messages[454].getExtra(3) + getCastle().getCName() + MessageTable.Messages[454].getExtra(4) + getCastle().getSiegeDate().getTime());
