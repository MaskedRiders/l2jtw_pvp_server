						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null)
						{
							...
							switch (grade)
							{
								case 0:
									 ...
									 */
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">" + MessageTable.Messages[595].getMessage() + "</a>]" + hp_grade0);
									break;
								case 1:
									/* MessageTable
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">Deactivate</a>]" + hp_grade1);
									 */
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">" + MessageTable.Messages[595].getMessage() + "</a>]" + hp_grade1);
									break;
								case 2:
									/* MessageTable
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">Deactivate</a>]" + hp_grade2);
									 */
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">" + MessageTable.Messages[595].getMessage() + "</a>]" + hp_grade2);
									break;
								case 3:
									/* MessageTable
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">Deactivate</a>]" + hp_grade3);
									 */
									html.replace("%change_hp%", "[<a action=\"bypass -h npc_%objectId%_manage recovery hp_cancel\">" + MessageTable.Messages[595].getMessage() + "</a>]" + hp_grade3);
									break;
							}
						}
						else
