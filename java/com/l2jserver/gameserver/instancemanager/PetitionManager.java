...
public final class PetitionManager
{
	...
	public void sendPendingPetitionList(L2PcInstance activeChar)
	{
		 ...
		 */
		final StringBuilder htmlContent = StringUtil.startAppend(600 + (getPendingPetitionCount() * 300), "<html><body><center><table width=270><tr>" + "<td width=45><button value=\"" + MessageTable.Messages[189].getMessage() + "\" action=\"bypass -h admin_admin\" width=45 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "<td width=180><center>" + MessageTable.Messages[190].getMessage() + "</center></td>" + "<td width=45><button value=\"" + MessageTable.Messages[191].getMessage() + "\" action=\"bypass -h admin_admin7\" width=45 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table><br>" + "<table width=\"270\">" + "<tr><td><table width=\"270\"><tr><td><button value=\"" + MessageTable.Messages[192].getMessage() + "\" action=\"bypass -h admin_reset_petitions\" width=\"80\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "<td align=right><button value=\"" + MessageTable.Messages[193].getMessage() + "\" action=\"bypass -h admin_view_petitions\" width=\"80\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table><br></td></tr>");
		...
		for (Petition currPetition : getPendingPetitions().values())
		{
			...
			if (currPetition.getState() != PetitionState.IN_PROCESS)
			{
				 ...
				 */
				StringUtil.append(htmlContent, "<table width=\"130\" cellpadding=\"2\"><tr>" + "<td><button value=\"" + MessageTable.Messages[196].getMessage() + "\" action=\"bypass -h admin_view_petition ", String.valueOf(currPetition.getId()), "\" width=\"50\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "<td><button value=\"" + MessageTable.Messages[197].getMessage() + "\" action=\"bypass -h admin_reject_petition ", String.valueOf(currPetition.getId()), "\" width=\"50\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table>");
			}
			else
			{
	...
	public int submitPetition(L2PcInstance petitioner, String petitionText, int petitionType)
	{
		 ...
		 */
		final String msgContent = petitioner.getName() + MessageTable.Messages[199].getMessage(); // (ID: " + newPetitionId + ").";
