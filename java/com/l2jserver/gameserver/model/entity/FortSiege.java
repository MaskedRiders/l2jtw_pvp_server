...
public class FortSiege implements Siegable
{
	...
	public void endSiege()
	{
		if (isInProgress())
		{
			 ...
			 */
			_log.info(MessageTable.Messages[441].getExtra(1) + getFort().getCName() + MessageTable.Messages[441].getExtra(2));
	...
	public void startSiege()
	{
		if (!isInProgress())
		{
			 ...
			 */
			_log.info(MessageTable.Messages[441].getExtra(1) + getFort().getCName() + MessageTable.Messages[441].getExtra(3));
	...
	public void checkAutoTask()
	{
		...
		else
		{
			...
			else
			{
				 ...
				 */
				_log.info(MessageTable.Messages[441].getExtra(1) + getFort().getCName() + MessageTable.Messages[441].getExtra(4) + getFort().getSiegeDate().getTime());
			}
		}
	}
