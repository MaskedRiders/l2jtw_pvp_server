...
public abstract class Inventory extends ItemContainer
{
	...
	//public static final int ?????????????? = 25; // 603-1
	//public static final int ?????????????? = 26; // 603-2
	//public static final int ?????????????? = 27; // 603-3
	//public static final int ?????????????? = 28; // 603-4
	//public static final int ?????????????? = 29; // 603-5
	//public static final int ?????????????? = 30; // 603-6
	//public static final int ?????????????? = 31; // 603-7
	//public static final int ?????????????? = 32; // 603-8
	//public static final int ?????????????? = 33; // 603-9
	//public static final int ?????????????? = 34; // 603-10
	//public static final int ?????????????? = 35; // 603-11
	//public static final int PAPERDOLL_TOTALSLOTS = 36; // 603
